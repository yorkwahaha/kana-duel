window.KanaBattleOnlineClient = (() => {
  ...
  const ERROR_MESSAGES = {
    ...
    INVALID_CONFIG: "房間設定無效。",
    UNKNOWN_SKILL: "無法使用這個技能。",
    UNKNOWN_CHARACTER_SKILL: "無法使用這個角色技能。",
    NOT_ENOUGH_COMBO: "COMBO 不足。",
    NO_CHARGE: "目前沒有可發動的蓄力。",
    HP_FULL: "目前體力已滿。",
    NO_TARGET_CHARGE: "對手目前沒有可奪取的蓄力。",
    NO_TARGET_COMBO: "對手目前沒有可削減的 COMBO。",
    QUESTION_ALREADY_DISRUPTED: "這題已經干擾過，不能重複使用墨鎖。",
    BOOST_ALREADY_READY: "連鳴已待機。",
    REFLECT_ALREADY_READY: "霜返已待機。",
    MISTAKE_GUARD_ALREADY_READY: "風閃已待機。",
    DODGE_ALREADY_READY: "已有閃避待機，不能同時使用格擋。",
    DODGE_AT_MAX: "閃避已達上限。",
    REGEN_ALREADY_ACTIVE: "光癒正在回復中。",
