...
| ID | 名稱 | 稱號 | 必殺 | 立繪 |
|----|------|------|------|------|
| ran | 風蹴・嵐 | 風蹴 | 嵐脚千刃 | `ran.webp`（`ran-atk.webp` / `ran-hit.webp`） |
| gen | 影刃・玄 | 影刃 | 墨影千刹 | `gen.webp`（`gen-atk.webp` / `gen-hit.webp`） |
...
- `assets/voice/{id}/hit.mp3` … 受擊
- `assets/voice/{id}/defeat.mp3` … 敗北

缺檔時：大招改播立繪約 3 秒；語音靜默略過。
