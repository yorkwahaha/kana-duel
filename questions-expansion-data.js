/**
 * 題庫整理與擴充：保留實用詞，移除較冷門角色／招式，總數整理為 360 題。
 * 音檔尚未綁定供應商；之後可依 id 產生 Fish Audio 等靜態語音檔。
 */
(() => {
  ...
  const groups = {
    ...
    action: [
      ["okimasu", "おきます", "起きます", "起床"], ["nemasu", "ねます", "寝ます", "睡覺"], ["arukimasu", "あるきます", "歩きます", "走路"], ["hashirimasu", "はしります", "走ります", "跑步"], ["oyogimasu", "およぎます", "泳ぎます", "游泳"],
      ["norimasu", "のります", "乗ります", "搭乘"], ["orimasu", "おります", "降ります", "下車"], ["aimasu", "あいます", "会います", "見面"], ["machimasu", "まちます", "待ちます", "等待"], ["tsukaimasu", "つかいます", "使います", "使用"],
      ["tsukurimasu", "つくります", "作ります", "製作"], ["kaerimasu", "かえります", "帰ります", "回去"], ["hairimasu", "はいります", "入ります", "進入"], ["demasu", "でます", "出ます", "出去"], ["akemasu", "あけます", "開けます", "打開"],
      ["shimemasu", "しめます", "閉めます", "關上"], ["arimasu", "あります", null, "有（無生命）"], ["imasu", "います", null, "有（生命）"], ["wasuremasu", "わすれます", "忘れます", "忘記"], ["oboemasu", "おぼえます", "覚えます", "記住"],
    ],
    daily: [
